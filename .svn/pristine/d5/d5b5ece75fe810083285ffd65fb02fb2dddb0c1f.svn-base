...
REDIPS.drag = function() {
    ...
    Oa = function(a, c, b) {
        ...
        ///Modified by nandha Start /////

        var arraynew = [];
        for (var j = 0, col; col = c.cells[j]; j++) {
            if (j == 0) {
                arraynew.push(c.rowIndex);
            }
            if (j != 1 && j > 0) {
                arraynew.push(col.innerText);
            }
        }

        var value = '<tr class="row_to_clone"><td class="td d-none"><div class="redips-drag redips-row">Newrow</div></td>' +
            '<td class="td"><div class="redips-drag blue redips-clone" onclick="myFunction(this)">' + arraynew[1] +'</div><span class="delete_ind" onclick="myclose(this)"><i class="fas fa-times"></i></span>' +
            '<td class="td"><div class="redips-drag blue redips-clone" onclick="myFunction(this)">' + arraynew[2] +'</div><span class="delete_ind" onclick="myclose(this)"><i class="fas fa-times"></i></span>' +
            '<td class="td"><div class="redips-drag blue redips-clone" onclick="myFunction(this)">' + arraynew[3] +'</div><span class="delete_ind" onclick="myclose(this)"><i class="fas fa-times"></i></span>' + 
            '<td class="td"><div class="redips-drag blue redips-clone" onclick="myFunction(this)">' + arraynew[4] +'</div><span class="delete_ind" onclick="myclose(this)"><i class="fas fa-times"></i></span>' +
            '<td class="td"><div class="redips-drag blue redips-clone" onclick="myFunction(this)">' + arraynew[5] + '</div><span class="delete_ind" onclick="myclose(this)"><i class="fas fa-times"></i></span>' +
            '<td class="td"><div class="redips-drag blue redips-clone" onclick="myFunction(this)">' + arraynew[6] + '</div><span class="delete_ind" onclick="myclose(this)"><i class="fas fa-times"></i></span>' +
            '<td class="td"><span onclick="deleterow(this)"><i class="fas fa-trash-alt"></i></span></td>' +
            '</tr>';
        c.innerHTML = "";
        c.innerHTML = value;
       

        ///Modified by nandha End /////
    ...
    ma = function(a) {
        ...
        if (!1 !== a) {
            ...
            if (k.target.hasChildNodes());
            {
                //console.log(k.target.childElementCount);

                if (k.target.childElementCount > 1)
                {
                    //console.log(k.target.firstChild);

                    k.target.firstChild.remove();
                }
            }

            if (k.target.classList.contains("th"))
            {
                if (k.target.childNodes.length > 1)
                {
                    k.target.removeChild(k.target.childNodes[1]);
                    k.target.removeChild(k.target.childNodes[2]);
                }
            }
            if (k.target.classList.contains("td"))
            {
                if (k.target.childNodes.length > 1)
                {
                    k.target.removeChild(k.target.childNodes[0]);
                }
            }

            if (k.target.firstChild.innerText == "x")
            {
                k.target.firstChild.remove();
            }


                //console.log(k.target,"fiuu");
                var elm = k.target.firstChild;
                var vall = elm.innerText;
                var value = '<div class="redips-drag blue redips-clone" onclick="myFunction(this)">' + vall + '</div><span class="delete_ind" onclick="myclose(this)"><i class="fas fa-times"></i></span>';
    ...
    ga = function(a) {
        ...
        //console.log(REDIPS.drag.objOld);
        //console.log(REDIPS.drag.obj);
