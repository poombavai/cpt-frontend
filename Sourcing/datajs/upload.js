  ...
  //       }
		...
		function Sourceupload()
		{
		     ...
		     while (chunk = FileChunk.shift())
		    {
		        ...
		        console.log(FilePartName);
		        // send the file
		        SourceUploadFileChunk(chunk, FilePartName);
		    }
				  
		}

		function SourceUploadFileChunk(Chunk, FileName) {
			debugger;
            var id = window.location.search.substring(1);
            id=id.replace("project_id=","");
            localStorage.setItem('MyId', id);
           
             var url = GlobalURl+"/projects/source_project_file?project_id="+id;
             //var url = "http://192.168.1.58:3031/projects/project_file?project_id="+id;
			    ...
			    xhr.onreadystatechange = function() {
			        if (xhr.readyState === 4) {
			            ...
			            localStorage.setItem('SourceUploadResponse', xhr.responseText);
             ...
             //var url = "http://192.168.1.58:3031/projects/project_file?project_id="+id;
			    ...
			    xhr.onreadystatechange = function() {
			        if (xhr.readyState == XMLHttpRequest.DONE) {
			            ...
			            localStorage.setItem('SourceUploadResponse', xhr.responseText);
			            window.location="Choose-columnSourcing.html";
